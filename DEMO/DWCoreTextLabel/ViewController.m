...
//    label.exclusionPaths = @[[UIBezierPath bezierPathWithRect:CGRectMake(0, 50, 50, 50)]].mutableCopy;
    ...
    [label dw_DrawImage:[UIImage imageNamed:@"oldDriver"] withImageID:@"URL" path:[UIBezierPath bezierPathWithOvalInRect:CGRectMake(13,53, 120, 120)] margin:0 drawMode:(DWTextImageDrawModeSurround) target:self selector:@selector(clickHeader)];
