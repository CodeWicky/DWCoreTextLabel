...
////    [label dw_InsertImage:[UIImage imageNamed:@"2.jpg"] withImageID:@"URL" size:CGSizeMake(70, 170) padding:-25 descent:0 atLocation:91 target:self selector:@selector(clickPic)];
...
//-(void)clickHeader
//{
//    [self.label dw_RemoveImageByID:@"URL"];
