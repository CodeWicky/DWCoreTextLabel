...
- (void)viewDidLoad {
    ...
    label.text = @"";
    label.backgroundColor = [UIColor colorWithRed:253 / 255.0 green:249 / 255.0 blue:218 / 255.0 alpha:1];
    label.textInsets = UIEdgeInsetsMake(50, 50, 0, 10);
    label.textColor = [UIColor blueColor];
    [self.view addSubview:label];
    label.exclusionPaths = @[[UIBezierPath bezierPathWithRect:CGRectMake(10, 5, 120, 120)]].mutableCopy;
//    [label dw_InsertImage:[UIImage imageNamed:@"2.jpg"] size:CGSizeMake(414 - 50 - 20, 170) padding:25 descent:0 atLocation:91 target:self selector:@selector(clickPic)];
    [label dw_DrawImage:[UIImage imageNamed:@"oldDriver"] WithPath:[UIBezierPath bezierPathWithOvalInRect:CGRectMake(10,5, 120, 120)] margin:5 drawMode:(DWTextImageDrawModeCover) target:self selector:@selector(clickHeader)];
